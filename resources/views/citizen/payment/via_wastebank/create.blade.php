...
<div class="row" style="padding: 25px">
    ...
    <form action="" method="POST">
        @csrf
        <div class="card-body">
        <input type="hidden" name="metode_bayar" value="bank_sampah">
        ...
        <div class="mb-4 row align-items-center">
          ...
          <div class="mb-4 row align-items-center">
            <label for="exampleInputText1" class="form-label col-sm-3 col-form-label">Saldo Bank Sampah</label>
            <div class="col-sm-9">
              <input type="text" class="form-control" value="Rp {{ number_format($saldoBankSampah, 0, ',', '.') }}" readonly>
            </div>
          </div>
