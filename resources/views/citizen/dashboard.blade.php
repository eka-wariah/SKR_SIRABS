                ...
                <div class="col-sm-7">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="border-end pe-4 border-muted border-opacity-10">
                      <h3 class="mb-1 fw-semibold fs-8 d-flex align-content-center">Rp{{ number_format($saldoBankSampah, 0, ',', '.') }}<i class="ti ti-arrow-up-right fs-5 lh-base text-success"></i>
                      </h3>
                      <p class="mb-0 text-dark">Saldo Bank Sampah</p>
                    </div>
                    <div class="ps-4">
