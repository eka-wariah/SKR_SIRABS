...
<html
  ...
  <body>
                  ...
                  <div class="row gy-4">
                    ...
                    <div class="col-lg-4 d-none d-lg-block">
                      <div class="bg-body nav-img-col p-2">
                        <img
                          src="{{ asset('vuexy/assets/img/front-pages/misc/nav-item-col-img.png')}}"
            ...
            <div class="container">
              <div class="hero-text-box text-center position-relative">
                <h1 class="text-primary hero-title display-6 fw-extrabold">
                    Sistem Informasi Retribusi RW 04
                </h1>
                <h2 class="hero-sub-title h6 mb-6">
                    Membayar iuran air, sampah, dan menabung sampah kini lebih mudah<br class="d-none d-lg-block" />
                </h2>
                <div class="landing-hero-btn d-inline-block position-relative">
                  <span class="hero-btn-item position-absolute d-none d-md-flex fw-medium"
                    >Mulai gabung
                    <img
                    src="{{ asset('vuexy/assets/img/front-pages/icons/Join-community-arrow.png')}}"
                    alt="Join community arrow"
                    class="scaleX-n1-rtl"
                />
                </span>
                  <a href="/login" class="btn btn-primary btn-lg">Masuk Sekarang</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="container">
              ...
              <h4 class="text-center mb-1">
                <span class="position-relative fw-extrabold z-1"
                  >Fitur Unggulan
                  <img
                    src="{{ asset('vuexy/assets/img/front-pages/icons/section-title-icon.png')}}"
                    alt="laptop charging"
                    class="section-title-img position-absolute object-fit-contain bottom-0 z-n1" />
                </span>
              </h4>
              <p class="text-center mb-12">
                Sistem kami hadir dengan fitur lengkap untuk kebutuhan warga RW 04
              </p>
              <div class="features-icon-wrapper row gx-0 gy-6 g-sm-12">
                <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                  ...
                  <h5 class="mb-2">Pembayaran Retribusi<</h5>
                  <p class="features-icon-description">
                    Cek dan bayar tagihan retribusi setiap bulan secara online.
                  </p>
                </div>
                <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                  <div class="mb-4 text-primary text-center">
    ...
    <section class="py-5 bg-light text-center" id="landingHero">
        <div class="container">
          <h1 class="display-4 fw-bold">Sistem Informasi Retribusi RW 04</h1>
          <p class="lead text-muted">Membayar iuran air, sampah, dan menabung sampah kini lebih mudah dan transparan.</p>
      ...
      <section class="py-5" id="landingFeatures">
        <div class="container">
          <div class="text-center mb-5">
            ...
            <p class="text-muted">Sistem kami hadir dengan fitur lengkap untuk kebutuhan warga RW 04</p>
          </div>
          <div class="row text-center">
            <div class="col-md-4 mb-4">
              <i class="fas fa-tint fa-3x text-primary mb-3"></i>
              <h5>Pembayaran Air</h5>
              <p class="text-muted">Cek dan bayar tagihan air setiap bulan secara online.</p>
            </div>
            <div class="col-md-4 mb-4">
              <i class="fas fa-trash-alt fa-3x text-success mb-3"></i>
              <h5>Retribusi Sampah</h5>
              <p class="text-muted">Iuran kebersihan bulanan tercatat otomatis dan transparan.</p>
            </div>
            <div class="col-md-4 mb-4">
              <i class="fas fa-recycle fa-3x text-warning mb-3"></i>
              <h5>Bank Sampah</h5>
              <p class="text-muted">Kelola saldo sampah, setor, dan tarik tabungan dengan mudah.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="py-5 bg-light" id="tentang">
        <div class="container d-flex flex-column flex-md-row align-items-center">
          <div class="col-md-6 mb-4 mb-md-0">
            <img src="{{ asset('vuexy/assets/img/illustrations/eco-technology.png') }}" alt="SIBEL" class="img-fluid">
          </div>
          <div class="col-md-6 ps-md-5">
            <h3 class="fw-bold">Apa itu Sistem SIBEL?</h3>
            <p class="text-muted">SIBEL (Sistem Informasi Iuran dan Bank Sampah Lingkungan) adalah platform digital untuk membantu warga RW 04 mengelola pembayaran dan tabungan secara efisien dan modern.</p>
            <ul class="list-unstyled">
              <li><i class="fas fa-check-circle text-success me-2"></i> Pembayaran non-tunai</li>
              <li><i class="fas fa-check-circle text-success me-2"></i> Riwayat pembayaran lengkap</li>
              <li><i class="fas fa-check-circle text-success me-2"></i> Integrasi saldo bank sampah</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section class="py-5" id="howitworks">
        <div class="container text-center">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="mb-3">
                <span class="badge bg-primary rounded-pill p-3">1</span>
              </div>
              <h5>Daftar & Login</h5>
              <p class="text-muted">Warga mendaftar akun menggunakan NIK dan nomor KK.</p>
            </div>
            <div class="col-md-4">
              <div class="mb-3">
                <span class="badge bg-success rounded-pill p-3">2</span>
              </div>
              <h5>Lihat Tagihan</h5>
              <p class="text-muted">Tagihan air dan sampah akan muncul otomatis setiap bulan.</p>
            </div>
            <div class="col-md-4">
              <div class="mb-3">
                <span class="badge bg-warning rounded-pill p-3">3</span>
              </div>
              <h5>Bayar & Kelola Saldo</h5>
              <p class="text-muted">Lakukan pembayaran dan cek saldo bank sampah secara real-time.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="py-5 bg-primary text-white text-center">
        <div class="container">
          ...
          <p class="lead">Mudah, cepat, dan tanpa antre.</p>
          <a href="{{ route('register') }}" class="btn btn-light btn-lg mt-3">Daftar Sekarang</a>
        </div>
      </section>
      <!-- Footer: End -->
