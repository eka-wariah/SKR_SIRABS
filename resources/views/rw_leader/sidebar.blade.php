<aside id="layout-menu" class="layout-menu menu-vertical menu">
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-header small">
        <span class="menu-header-text" data-i18n="Data Bendahara">Data Bendahara</span>
      </li>
      <!-- e-commerce-app menu start -->
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          <i class="menu-icon icon-base ti tabler-address-book"></i>
          <div data-i18n="Kelola Data Bendahara">Kelola Data Bendahara</div>
        </a>
        <ul class="menu-sub">
          <li class="menu-item">
          ...
          <li class="menu-item">
            <a href="/rw_leader/area_scope" class="menu-link">
              <div data-i18n="Lingkup Wilayah">Lingkup Wilayah</div>
            </a>
          </li>
