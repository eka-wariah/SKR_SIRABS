    ...
    <div class="col-lg-12">
          ...
          <form action="" method="post">
            ...
            <div class="card-body">
                <div class="mb-4 row align-items-center">
                  ...
                  <div class="col-sm-9">
                    <select class ="form-select mr-sm-2" id="inLineFormCustomSelect" name="asc_level" oninvalid="this.setCustomValidity ('Hari Wajib Diisi')"
      ...
                </div>
                  <div class="mb-4 row align-items-center">
                    ...
                    <div class="col-sm-9">
                      <input type="number" name="asc_number" class="form-control" id="exampleInputText1" placeholder="" required oninvalid="this.setCustomValidity('Nama Jurusan Wajib Diisi')" 
